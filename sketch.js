...
function preload(){
  ...
  elsa=loadImage("Elsa-and-Anna-image-elsa-and-anna-36197065-550-648.gif");
}
...
function setup() {
  ...
  //creating sword
   knife=createSprite(width-40,200,20,20);
...
function Monster(){
  if(World.frameCount%200===0){
    ...
    monster.y=(Math.round(random(50,width-50),40,10,10))
